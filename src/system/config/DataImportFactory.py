...
class DataImportFactory(object):
    ...
    :param system: reference to the MincePy system instance
    :type system: :class:`.System`
    :param configHelper: reference to the MincePy configuration helper
    ...
    def __createFileDbDataImport(self, importTitle, importInfo):
        path = self.__configHelper.getAbsolutePath(importInfo["file"])
    ...
    def createDataImportsFromConfig(self, importConfigSection):
        ...
        for importTitle in sorted(
            ...
            if "file" in importInfo:
                importInfo["file"] = self.__cacheIfRemote(importTitle,
                                                          importInfo["file"])

...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Process MincePy.")
    ...
    try:
        ...
        log = logging.getLogger("app.MincePy")
        log.info("MincePy Configuration")
